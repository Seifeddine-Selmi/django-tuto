...
urlpatterns = [
    ...
    url(r'^article/(?P<slug>\w+)$', views.DetailArticle.as_view(), name='blog_article'),

    url(r'^add_article', views.ArticleCreate.as_view(), name='add_article'),
    url(r'^edit_article/(?P<slug>\w+)$', views.ArticleUpdate.as_view(), name='edit_article'),
    url(r'^delete_article/(?P<slug>\w+)$', views.ArticleDelete.as_view(), name='delete_article'),
